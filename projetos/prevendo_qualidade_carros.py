...
adicionar_tecnologia(tecnologias['Python'], "Linguagem de programação utilizada para treinar o modelo de machine learning e criar a interface", 150, coluna1)
adicionar_tecnologia(tecnologias['Pandas'], "Biblioteca do Python usada para carregar os dados.", 150, coluna2)
adicionar_tecnologia(tecnologias['Scikit-learn'], "Biblioteca do Python usada para treinar o modelo de machine learning (Random Forest Classifier).", 100, coluna3)
adicionar_tecnologia(tecnologias['Streamlit'], "Biblioteca do Python usada para criar a interface do projeto na web.", 150, coluna1)
st.divider()
